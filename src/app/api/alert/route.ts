...
// Corps : { kind: 'screenshot' | 'tab_hidden' } ; jeton étudiant par
// l'en-tête « Authorization: Bearer … » (repli ?token= accepté).
//
...
export async function POST(req: NextRequest) {
  try {
    ...
    await db.alertEvent.create({ data: { studentId: student.id, kind } })
