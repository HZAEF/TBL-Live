...
export const FR_KEYS: readonly string[] = [
  ...
  "Double envoi détecté : votre équipe a déjà répondu à cette question.",
  ...
  "Votre code personnel est bien enregistré :",
